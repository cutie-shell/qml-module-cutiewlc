...
void CutieWlcPlugin::registerTypes(const char *uri)
{
	...
	qmlRegisterType<ForeignToplevelManagerV1>(uri, 1, 0,
						  "ForeignToplevelManagerV1");
	qmlRegisterUncreatableType<ForeignToplevelHandleV1>(
		uri, 1, 0, "ForeignToplevelHandleV1",
	...
	qmlRegisterType<OutputPowerManagerV1>(uri, 1, 0,
